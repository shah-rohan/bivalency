...
simple_roc_notrim(hmd_diffexp_naive_npc$diffexp, hmd_diffexp_naive_npc$methyl, rev = T, title_text = "ROC Curve of Differential Expression from Naive to NPC by Methylation")
...
simple_roc_notrim(hmd_diffexp_primed_npc$diffexp, hmd_diffexp_primed_npc$methyl, rev = T, title_text = "ROC Curve of Differential Expression from Primed to NPC by Methylation")
