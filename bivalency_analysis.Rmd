...
go_term_pvals %>% inner_join(go_classic_tables$biv_loss_de, by = "GO.ID") %>% select(GO.ID, Term, p.adj)
...
go_term_pvals %>% inner_join(go_classic_tables$biv_loss_de_up, by = "GO.ID") %>% select(GO.ID, Term, p.adj)
...
go_term_pvals %>% inner_join(go_classic_tables$biv_loss_de_down, by = "GO.ID") %>% select(GO.ID, Term, p.adj)
