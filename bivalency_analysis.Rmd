...
if (!file.exists("sleuth_analysis.RData")){
  ...
  save.image("sleuth_analysis.RData")
} else{
  load("sleuth_analysis.RData")
}
...
We see only subtle changes at best. The other obvious thing is to look at upregulated genes, downregulated genes, and insignificantly changed genes to look at bivalency metaprofiles there.
